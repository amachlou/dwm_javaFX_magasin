...
import interfaces.ListeProduits;
import interfaces.ListeVentes;
import interfaces.Main;
import interfaces.NouveauVente;
import javafx.scene.control.DatePicker;
import javafx.scene.control.cell.PropertyValueFactory;
import javafx.stage.Stage;
import ligneCommande.ILigneCommandeDAO;
import ligneCommande.LigneCommande;
import ligneCommande.LigneCommandeDaoImpl;
...
public class VenteHandler {
	...
	public void addCommandeToTable() {	
		...
		double sousTotal=0;
		long id_produit=Long.valueOf(nouveauVente.id_produit.getText());
		long id_vente=Long.valueOf(nouveauVente.numVenteInput.getText());
